...
describe('Books Endpoints', () => {
  ...
  describe('GET /api/books/:id', () => {
    ...
    it('returns book with reviews and related', async () => {
      pool.query
        .mockResolvedValueOnce([[{ id: 1, title: 'Sapiens', genre: 'History', is_active: 1 }]])
        .mockResolvedValueOnce([[{ id: 10, rating: 5, comment: 'Great!', reviewer_name: 'Alice' }]])
        .mockResolvedValueOnce([[{ id: 2, title: 'Guns', genre: 'History' }]]);
